                                        ...
                                        <div className='mt-5'>
                                            ...
                                            <div className='mt-4 border border-[#001356] rounded-md lg:w-[60%] cursor-pointer'>
                                                <div className='px-2'>
                                                    ...
                                                    <div className='grid grid-cols-2 md:grid-cols-5 gap-4 mt-1 pb-2 text-sm'>
                                                    ...
                                                    <div className='grid grid-cols-3 md:flex items-center gap-4 mt-2'>
                                                    ...
                                                    <div className='grid grid-cols-3 md:flex items-center gap-4 my-3'>
