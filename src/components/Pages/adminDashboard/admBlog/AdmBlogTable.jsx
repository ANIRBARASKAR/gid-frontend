                        ...
                        <table className="w-[100%] mt-8 text-xs md:text-base">
                            <thead>
                                <tr className='text-[#001356] text-left'>
                                    ...
                                    <th className='py-4 px-4 md:px-0'>Title</th>
                                    <th className='py-4 px-4 md:px-0'>Written By</th>
                                    <th className='py-4 px-4 md:px-0'>Image</th>
                                    <th className='py-4 px-4 md:px-0'>Is Publish</th>
                                </tr>
                            </thead>
                            <tbody>
                                {data.map((item, index) => (
                                    <tr key={index} className="border-b border-gray-300 text-gray-500">
                                        ...
                                        <td className='py-4 px-4 md:px-0'>{item.title}</td>
                                        <td className='py-4 px-4 md:px-0'>{item.author}</td>
                                        <td className='py-4 px-4 md:px-0 flex items-center gap-4'>
