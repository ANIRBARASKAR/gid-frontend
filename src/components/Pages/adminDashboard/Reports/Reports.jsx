    ...
    return (
        <>
            <div className="lg:ml-[300px] lg:pr-6">
                <div className="mt-8">
                    <h1 className="text-[#001356] text-[26px] font-bold">Reports</h1>
                    ...
                    <div className="bg-white mt-5 py-8 px-6 rounded-lg" style={{ boxShadow: "0px 4px 4px 0px #00000040" }}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 md:gap-8 mt-5">
                            ...
                            <div className="mb-4">
                                <label htmlFor="Organizer" className="block text-[#001356] text-base font-medium">Event Date</label>
                                <select
                                    id="organizer"
                                    name="organizer"
                                    className="w-full border border-[#001356] rounded-md p-1 mt-1"
                        ...
                        <div className='flex justify-center'>
                            <button
                                type="submit"
                                className="bg-[#284B80] text-white px-6 py-2 rounded-lg flex items-center gap-4"
                            >
